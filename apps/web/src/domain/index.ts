// Inlined copy of packages/domain/src/index.ts — keeps the web bundle
// self-contained and avoids the workspace dependency in the Railway
// NIXPACKS build. Source of truth remains packages/domain/src/index.ts;
// keep these in sync if the domain model changes.
