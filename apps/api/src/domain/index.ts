// Inlined copy of packages/domain/src/index.ts.
// Eliminates the @animbook/domain workspace dependency for the API build
// so Railway's NIXPACKS build doesn't need to pre-compile the workspace
// package. Source of truth remains packages/domain/src/index.ts — keep
// them in sync if the domain model changes.
